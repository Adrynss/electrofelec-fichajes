(async()=>{
  ...
  try{
    const fix=await fetch('https://raw.githubusercontent.com/Adrynss/electrofelec-fichajes/main/pdf-destination-fix-575.js?v=575-local2',{cache:'no-store'}).then(r=>r.text());
    (0,eval)(fix);
