const CACHE='electrofelec-worker-v148';
const ASSETS=['./','./index.html','./style.css?v=148','./app.js?v=148','./app-fichajes-incident-fix-v147.js?v=1','./app-manual-hours-v148.js?v=1','./manifest.webmanifest?v=148','./icon.svg?v=148'];
