const CACHE='electrofelec-worker-v147';
const ASSETS=['./','./index.html','./style.css?v=147','./app.js?v=147','./app-fichajes-incident-fix-v147.js?v=1','./manifest.webmanifest?v=147','./icon.svg?v=147'];
