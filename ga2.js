...
try{let prl=await fetch('https://raw.githubusercontent.com/Adrynss/electrofelec-fichajes/main/gestor-cae-v203-prl-order.js?v=1',{cache:'no-store'});if(prl.ok)(0,eval)(await prl.text());else console.warn('No se pudo cargar orden PRL',prl.status)}catch(e){console.warn('Orden PRL',e)}
