...
const scripts=[
 ...
 ['gestor-payroll-v211-net-target-ui.js',1]
];
...
try{let labels=await fetch('https://kbdmraxjfgtttopsyfuy.supabase.co/functions/v1/electrofelec-accounting-labels-ui',{cache:'no-store'});if(labels.ok)(0,eval)(await labels.text());else console.warn('No se pudieron cargar etiquetas de Contabilidad',labels.status)}catch(e){console.warn('Etiquetas Contabilidad',e)}
